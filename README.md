...
### **⚡ Power & Thermal Management Research**

#### **CPINN-ABPI: Physics-Informed Neural Networks for Accurate Power Estimation in MPSoCs**
First hardware validation of ABPI on NVIDIA Jetson Xavier AGX, introducing CPINN-ABPI—a hybrid model fusing physics-informed neural networks with the ABPI thermal model and NSGA-II multi-objective tuning.
...
#### **[Cluster-BPI: Efficient Fine-Grain Blind Power Identification](https://ieeexplore.ieee.org/document/10765816)**
...
#### **[Fine-Grained Clustering-Based Power Identification for Multicores](https://arxiv.org/abs/2409.18921)**
...
#### **[Thermal Vulnerability of 3D-Stacked High-Bandwidth Memory](https://arxiv.org/abs/2509.00633)**
...
- **Connectivity**: I²C, Serial, Wi-Fi, Bluetooth, One-Wire protocols
...
#### **[Brain Tumor Detection with Deep Learning](https://onlinelibrary.wiley.com/doi/full/10.1002/cpe.7031)**
...
#### **[Real-Time Ball Balancer System](https://onlinelibrary.wiley.com/doi/10.1002/cpe.7317)**
...
#### **[n8n AI Agent Course](https://github.com/MohElshamy1994/n8n-course-Projetcs)**
...
#### **[Machine Learning Course 2025](https://github.com/MohElshamy1994/machine-learning-course-2025)**
...
```
Power Modeling         │ Physics-Informed Neural Networks (PINNs), Blind Power Identification (BPI)
Thermal Analysis       │ RC lattice modeling, steady-state thermal analysis, dynamic thermal management
Optimization           │ NSGA-II multi-objective optimization, DBSCAN clustering, NMF
Hardware Validation    │ NVIDIA Jetson Xavier AGX, heterogeneous SoC benchmarking
Simulation Tools       │ MATLAB/Simulink, thermal/power profiling frameworks
```

### **🤖 AI/ML Technologies**
```
Large Language Models  │ OpenAI GPT, Claude, Gemini, DeepSeek, xAI, LLaMA
Deep Learning          │ PyTorch, TensorFlow, Keras, Scikit-learn, NumPy, Pandas
Computer Vision        │ YOLO, OpenCV, TensorFlow Object Detection
Specialized ML         │ NVIDIA cuML, Physics-Informed Neural Networks, TinyML
AI Tools               │ n8n, LangChain, Cursor Agents, AutoGen, CrewAI
Vector Databases       │ Pinecone, Weaviate, Chroma, FAISS
```

### **💻 Programming & Development**
```
Languages              │ Python, MATLAB, C/C++, MicroPython, Verilog/VHDL
Development Tools      │ Cursor, VS Code, Anaconda, Git, Docker, Linux, Jupyter
Cloud Platforms        │ AWS, Google Cloud, Azure, Hostinger
Databases              │ PostgreSQL, MongoDB, SQLite, Redis
```

### **🔧 Hardware & Embedded Systems**
```
PCB Design             │ Altium Designer, KiCad (multi-layer, high-speed, low-power)
Power Electronics      │ LT Spice, P-Spice, power inverter design
Microcontrollers       │ ESP32-S3, STM32, Arduino, PIC, AVR, ARM Cortex M0
Development Boards     │ NVIDIA Jetson Xavier AGX, Raspberry Pi 4, Xilinx Zybo Z7
FPGA Development       │ Xilinx, Verilog/VHDL
Communication          │ UART, SPI, I²C, One-Wire, LIN, CAN
Firmware               │ MicroPython, real-time systems, OTA updates
Compliance             │ FCC/UL/ATEX-compliant design for automotive/industrial applications
```
...
Statistical Analysis   │ Regression models (SVR, Decision Tree, Random Forest)
Signal Processing      │ MATLAB/Simulink for hardware modeling and analysis
```
...
- **[AI Plus ME YouTube Channel](https://www.youtube.com/@AIPlus_ME)** - AI education and tutorials
...
- **🎥 YouTube**: [AI Plus ME](https://www.youtube.com/@AIPlus_ME) - AI tutorials and courses
- **💼 LinkedIn**: [Mohamed Elshamy](https://www.linkedin.com/in/moh-elshamy/) - Professional networking
- **📚 Google Scholar**: [Research Publications](https://scholar.google.com/citations?user=OIW1wDYAAAAJ&hl=en)
- **🔬 ResearchGate**: [Academic Profile](https://www.researchgate.net/profile/Mohamed-Elshamy-6)
- **🐙 GitHub**: [MohElshamy1994](https://github.com/MohElshamy1994) - Open source projects
...
**⭐ Interested in power management research, hardware security, AI/ML collaboration, or consulting? Let's connect and build the future of secure, energy-efficient computing systems!**
